  ...
  group('Security', () {
    test(
      ...
      () async {
        ...
        final innerTemp = await Directory.systemTemp.createTemp(
          'cover_security_inner',
        );
    ...
    test(
      'Path Traversal: should allow accessing file within working directory',
      () async {
        final tempDir = await Directory.systemTemp.createTemp(
          'cover_security_inside',
        );
